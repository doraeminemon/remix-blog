...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create remix-blog-a78e
  fly apps create remix-blog-a78e-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-blog-a78e
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-blog-a78e-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'remix-blog-a78e-staging' does not match app name in config file 'remix-blog-a78e'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name remix-blog-a78e-db
  fly postgres attach --app remix-blog-a78e remix-blog-a78e-db

  fly postgres create --name remix-blog-a78e-staging-db
  fly postgres attach --app remix-blog-a78e-staging remix-blog-a78e-staging-db
  ```
